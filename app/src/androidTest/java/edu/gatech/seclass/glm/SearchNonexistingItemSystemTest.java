...
public class SearchNonexistingItemSystemTest {
    ...
    @Test
    public void searchNonexistingItemSystemTest() {
        ...
        ViewInteraction appCompatImageView = onView(
                allOf(withClassName(is("android.support.v7.widget.AppCompatImageView")), withContentDescription("Search"),
                        withParent(allOf(withClassName(is("android.widget.LinearLayout")),
                                withParent(withId(R.id._search)))),
                        isDisplayed()));
        ...
        ViewInteraction searchAutoComplete = onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")),
                        ...
                        isDisplayed()));
        searchAutoComplete.perform(replaceText("lord of the rings"), closeSoftKeyboard());
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id._item_type_divider), withText("Cereal"),
                        isDisplayed()));
        textView2.check(doesNotExist());

        ViewInteraction textView3 = onView(
                allOf(withId(R.id._item_type_divider), withText("Condiments"),
                        isDisplayed()));
