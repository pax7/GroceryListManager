...
public class ViewListSystemTest {
    ...
    @Test
    public void viewListSystemTest() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id._item_type_divider), withText("Condiments"),
                        isDisplayed()));
        textView2.check(matches(withText("Condiments")));

        ViewInteraction textView3 = onView(
                allOf(withId(R.id._item_type_divider), withText("Drinks and Snacks"),
                        isDisplayed()));
        textView3.check(matches(withText("Drinks and Snacks")));
    }
